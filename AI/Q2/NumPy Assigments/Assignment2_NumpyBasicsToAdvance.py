...
def function3():
    ...
    x = x = a[((a%5==0) & (a%7==0))] #wrtie your code here
    return x
    """
    Expected Output:
...
def function8():
    ...
    x = np.zeros((2,5),dtype='uint32')#write your code here
    x[:]=6
...
def function12():
    ...
    arr = np.array([1,2,3])
    pat_a = np.repeat(arr,3)
    pat_b = np.tile(arr, 3)
    ans = np.hstack((pat_a,pat_b))#write your code here 
